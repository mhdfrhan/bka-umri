...
export default function EditPengumuman() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            ...
            const isSlugTaken = announcementList.some((a: any) => a.slug === slug && a.id !== announcementId);
            if (isSlugTaken) {
            ...
            const updatedList = announcementList.map((a: any) => a.id === announcementId ? updatedAnnouncement : a);
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-200 pb-5">
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 mt-1 font-light leading-relaxed">
                            Sesuaikan isi pengumuman, ubah tingkat penting, status publikasi, atau berkas lampiran.
                        </p>
                    </div>
                </div>
