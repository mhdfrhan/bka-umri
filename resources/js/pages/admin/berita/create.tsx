...
export default function TambahBerita() {
    ...
    const [thumbnail, setThumbnail] = useState('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&q=80');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            ...
            const nextId = newsList.length > 0 ? Math.max(...newsList.map((n: any) => n.id)) + 1 : 1;
            const newArticle = {
                id: nextId,
                title: title.trim(),
                slug: slug.trim(),
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-200 pb-5">
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 mt-1 font-light leading-relaxed">
                            Buat tulisan berita, laporan kegiatan, atau info pengumuman administrasi baru.
                        </p>
                    </div>
                </div>
